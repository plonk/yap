...
SRC = %w(channel.rb channel_info_label.rb channel_list_view.rb bandwidth_checker.rb
         ...
         main_window.rb mw_model.rb bandwidth_checker_manager.rb bandwidth_checker_window.rb
